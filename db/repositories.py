...
class MemoryRepository(Protocol):
    ...
    def get_owned(self, memory_id: str, *, owner_id: str) -> Any: ...
    ...
    def apply_event_reconciliation(self, record: Any, **kwargs: Any) -> Any: ...
    def find_memory_candidates(self, **kwargs: Any) -> list[Any]: ...
    ...
    def list_graph_relationships(self, *, owner_id: str, memory_id: str | None = None) -> list[Any]: ...
    ...
    def claim_projection_jobs(self, *, limit: int = 50, targets: set[str] | None = None) -> list[dict]: ...
    def enqueue_all_projections(self, *, targets: tuple[str, ...] = ("qdrant", "graph")) -> int: ...


class EvidenceRepository(Protocol):
    def upsert_asset(self, asset: Any) -> None: ...
    def get_asset(self, asset_id: str, **filters: Any) -> Any: ...
...
class GraphRepository(Protocol):
    ...
    def sync_relationship(self, relationship: Any) -> None: ...
    ...
    def expand_memory_candidates(self, *, seed_memory_ids: list[str], owner_id: str,
                                 ...
                                 project_scope: str | None, limit: int = 4) -> list[Any]: ...
